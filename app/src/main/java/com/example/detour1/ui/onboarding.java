...
import com.example.detour1.adapters.OnboardingAdapter;
import com.example.detour1.models.OnboardingItem;
...
public class onboarding extends AppCompatActivity {
    @BindView(R.id.layoutOnboardingIndicators)
    LinearLayout layoutOnboardingIndicators;
    @BindView(R.id.buttonOnboardingAction)
